    ...
    const columns = [
        ...
        },
        {
            ...
            render: (_: any, record: Payment) => {
                const expiring = isExpiringSoon(record.billing_period_end);
                ...
                return (
                    <Space direction="vertical" size={0}>
                        ...
                        <Text
                            ...
                            style={{
                                fontSize: "12px",
                                color: expiring ? "#ff4d4f" : undefined,
                                fontWeight: expiring ? 600 : undefined,
                            }}
                        >
    ...
    return (
        <div style={{ padding: "24px", maxWidth: 1000, margin: "0 auto" }}>
            ...
            <div style={{ marginBottom: 24 }}>
                <Breadcrumb
                    items={[
                        {
                            title: (
                                <Link href={`${tenantBasePath}/dashboard`}>
                                    Dashboard
                                </Link>
                            ),
                        },
                        {
                            title: (
                                <Link
                                    href={`${tenantBasePath}/subscription/register`}
                                >
                                    Gói dịch vụ
                                </Link>
                            ),
            ...
            <div style={{ marginTop: 24, textAlign: "center" }}>
                <Text type="secondary">
                    Nếu bạn đã thanh toán nhưng trạng thái chưa cập nhật, vui
                    lòng liên hệ hỗ trợ.
                </Text>
            </div>
        </div>
